...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha512', 'sha3-224', 'shake256', 'sha512-256', 'sha1', 'blake2b512', 'md5', 'sha224', 'sha512-224', 'shake128', 'sha384', 'sha3-512', 'sha3-256', 'ripemd160', 'blake2s256', 'sha3-384', 'sm3', 'md5-sha1', 'sha256', 'md4', 'whirlpool'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcb733f7cc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcb733f7cc0>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
